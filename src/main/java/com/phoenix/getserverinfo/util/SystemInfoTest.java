...
package com.phoenix.getserverinfo.util;
...
public class SystemInfoTest {
    ...
    private static void printComputerSystem(final ComputerSystem computerSystem) {
        ...
        System.out.println("SN号: " + computerSystem.getSerialNumber());
        ...
        System.out.println("  出版日期 " + (firmware.getReleaseDate() == null ? "unknown"
    ...
    private static void printProcessor(CentralProcessor processor) {
        ...
        System.out.println(" 物理CPU数" + processor.getPhysicalProcessorCount() + " physical CPU(s)");
        System.out.println(" 逻辑CPU数" + processor.getLogicalProcessorCount() + " logical CPU(s)");
        System.out.println("标识符: " + processor.getIdentifier());
        System.out.println("处理器ID: " + processor.getProcessorID());
    }
    private static void printMemory(GlobalMemory memory) {
        System.out.println("可以使用内存: " + FormatUtil.formatBytes(memory.getAvailable()) +
                            "总共内存" + FormatUtil.formatBytes(memory.getTotal()));
        System.out.println("交换区已使用: " + FormatUtil.formatBytes(memory.getSwapUsed()) +
                            "交换区总共" + FormatUtil.formatBytes(memory.getSwapTotal()));
    }
    private static void printCpu(CentralProcessor processor) {
        System.out.println("已正常运行时间: " + FormatUtil.formatElapsedSecs(processor.getSystemUptime()));
        long[] prevTicks = processor.getSystemCpuLoadTicks();
        System.out.println("第一次取值CPU, IOWait, and IRQ ticks @ 0 sec:" + Arrays.toString(prevTicks));
        // Wait a second...
        Util.sleep(1000);
        long[] ticks = processor.getSystemCpuLoadTicks();
        System.out.println("第二次取值CPU, IOWait, and IRQ ticks @ 1 sec:" + Arrays.toString(ticks));
        ...
        System.out.format("CPU load: %.1f%% (计数刻度)%n", processor.getSystemCpuLoadBetweenTicks() * 100);
        System.out.format("CPU load: %.1f%% (OS 负载)%n", processor.getSystemCpuLoad() * 100);
...
//        System.out.println(" 风扇转速: " + Arrays.toString(sensors.getFanSpeeds()));
        System.out.format(" CPU电压: %.1fV%n", sensors.getCpuVoltage());
    }
